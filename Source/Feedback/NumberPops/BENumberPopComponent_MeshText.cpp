...
#include "BENumberPopComponent_MeshText.h"
...
UBENumberPopComponent_MeshText::UBENumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UBENumberPopComponent_MeshText::AddNumberPop(const FBENumberPopRequest& NewRequest)
{
...
void UBENumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UBENumberPopComponent_MeshText::DetermineColor(const FBENumberPopRequest& Request) const
{
	for (UBEDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UBENumberPopComponent_MeshText::DetermineStaticMesh(const FBENumberPopRequest& Request) const
{
	for (UBEDamagePopStyle* Style : Styles)
	{
...
void UBENumberPopComponent_MeshText::SetMaterialParameters(const FBENumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
