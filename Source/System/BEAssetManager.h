 ...
 */
UCLASS(Config = Game)
class UBEAssetManager : public UAssetManager
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(Config)
		TSoftObjectPtr<UBEGameData> BEGameDataPath;
...
private:
	...
	TArray<FBEAssetManagerStartupJob> StartupJobs;
...
template<typename AssetType>
AssetType* UBEAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UBEAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
