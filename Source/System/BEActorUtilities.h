...
#include "BEActorUtilities.generated.h"
...
UCLASS()
class UBEActorUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "BE", meta = (WorldContext = "WorldContextObject", ExpandEnumAsExecs = ReturnValue))
