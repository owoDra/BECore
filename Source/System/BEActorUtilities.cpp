...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BEActorUtilities)

////////////////////////////////////////////////////////////

EBlueprintExposedNetMode UBEActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
