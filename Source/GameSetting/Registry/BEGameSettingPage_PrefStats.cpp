...
#include "GameSetting/CustomSetting/BESettingValueDiscrete_PerfStat.h"
...
void UBEGameSettingRegistry::AddPrefStatSettingsPage(UGameSettingCollection* Screen, UBELocalPlayer* InLocalPlayer)
{
