...
#include "BESettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UBESettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UBESettingValueDiscrete_Resolution();
