...
#include "BESettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BESettingValueDiscrete_Resolution)

//////////////////////////////////////////////////////////////////////

#define LOCTEXT_NAMESPACE "BESettings"

UBESettingValueDiscrete_Resolution::UBESettingValueDiscrete_Resolution()
{
}

void UBESettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UBESettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UBESettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UBESettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UBESettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UBESettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UBESettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UBESettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UBESettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UBESettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UBESettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UBESettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UBESettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UBESettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UBESettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UBESettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
