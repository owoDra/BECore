...
#include "BEInventoryManagerComponent.h"
...
void UPickupableStatics::AddPickupInventory(UBEInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickupable)
{
