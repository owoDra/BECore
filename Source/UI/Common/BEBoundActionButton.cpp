...
#include "BEBoundActionButton.h"
#include "CommonInputSubsystem.h"

void UBEBoundActionButton::NativeConstruct()
{
...
void UBEBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
