...
#include "BESimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="BE Simulated Input Widget" ))
class BECORE_API UBESimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UBESimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
