...
#include "BEAbilityTagRelationshipMapping.generated.h"
...
USTRUCT()
struct FBEAbilityTagRelationship
{
	GENERATED_BODY()

	/** The tag that this container relationship is about. Single tag, but abilities can have multiple of these */
	UPROPERTY(EditAnywhere, Category = Ability, meta = (Categories = "Ability.Type.Action"))
...
UCLASS()
class UBEAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FBEAbilityTagRelationship> AbilityTagRelationships;
