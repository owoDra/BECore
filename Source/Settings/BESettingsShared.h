...
public:
	UFUNCTION()
		bool ShouldOverrideAimingReticleColor() const { return bOverrideAimingReticleColor; }
	UFUNCTION()
		void SetOverrideAimingReticleColor(bool NewValue) { bOverrideAimingReticleColor = NewValue; }

	UFUNCTION()
		FLinearColor GetAimingReticleColor() const { return AimingReticleColor; }
	UFUNCTION()
		void SetAimingReticleColor(FLinearColor NewValue) { AimingReticleColor = NewValue; }
...
private:
	...
	UPROPERTY()
		FLinearColor AimingReticleColor = FLinearColor::Red;
