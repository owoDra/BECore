...
#include "Settings/CustomSettings/BESettingValueColorDynamic.h"
...
void UBEGameSettingRegistry::AddReticleSettingsPage(UGameSettingCollection* Screen, UBELocalPlayer* InLocalPlayer)
{
	...
	//	レティクル設定
	{
		...
		//======================================
		{
			...
			Setting->SetDisplayName(LOCTEXT("ReticleShouldOverrideColor_Name", "Should Override Aiming Reticle Color"));
			...
			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH(ShouldOverrideAimingReticleColor));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH(SetOverrideAimingReticleColor));
			Setting->SetDefaultValue(GetDefault<UBESettingsShared>()->ShouldOverrideAimingReticleColor());
		...
		//======================================
		{
			...
			Setting->SetDevName(TEXT("ReticleAimingColor"));
			Setting->SetDisplayName(LOCTEXT("ReticleAimingColor_Name", "Ainimg Reticle Color"));
			Setting->SetDescriptionRichText(LOCTEXT("ReticleAimingColor_Description", "Reticle color on aiming to override"));

			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH(GetAimingReticleColor));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH(SetAimingReticleColor));
			Setting->SetDefaultValue(GetDefault<UBESettingsShared>()->GetAimingReticleColor());
