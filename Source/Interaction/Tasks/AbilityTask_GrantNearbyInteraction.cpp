...
#include "Math/Quat.h"
#include "Physics/BECollisionChannels.h"
...
void UAbilityTask_GrantNearbyInteraction::QueryInteractables()
{
	...
	if (World && ActorOwner)
	{
		...
		World->OverlapMultiByChannel(OUT OverlapResults, ActorOwner->GetActorLocation(), FQuat::Identity, BE_TraceChannel_Interaction, FCollisionShape::MakeSphere(InteractionScanRange), Params);
