...
#include "BEVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BEVerbMessageHelpers)


//////////////////////////////////////////////////////////////////////
// FBEVerbMessage

FString FBEVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FBEVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UBEVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UBEVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UBEVerbMessageHelpers::VerbMessageToCueParameters(const FBEVerbMessage& Message)
{
...
FBEVerbMessage UBEVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FBEVerbMessage Result;
