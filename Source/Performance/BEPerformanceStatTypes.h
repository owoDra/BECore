...
#include "BEPerformanceStatTypes.generated.h"

//////////////////////////////////////////////////////////////////////

// Way to display the stat
UENUM(BlueprintType)
enum class EBEStatDisplayMode : uint8
{
...
UENUM(BlueprintType)
enum class EBEDisplayablePerformanceStat : uint8
{
	// stat fps (in Hz)
	ClientFPS,
...
ENUM_RANGE_BY_COUNT(EBEDisplayablePerformanceStat, EBEDisplayablePerformanceStat::Count);
