...
#include "BECharacterHealthComponent.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FBEHealth_AttributeChanged, UBECharacterHealthComponent*, HealthComponent, float, OldValue, float, NewValue, APawn*, Instigator);
...
/**
 * UBECharacterHealthComponent
 *
 *	キャラクターの Health や Death を管理するためのコンポーネント
 */
UCLASS(Blueprintable, Meta=(BlueprintSpawnableComponent))
class BECORE_API UBECharacterHealthComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()
...
public:
	...
	static UBECharacterHealthComponent* FindCharacterHealthComponent(const APawn* Pawn);
