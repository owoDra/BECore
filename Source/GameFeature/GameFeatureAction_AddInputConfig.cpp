...
#include "GameFeature/GameFeatureAction_AddInputConfig.h"
#include "Components/GameFrameworkComponentManager.h"
#include "EnhancedInputSubsystems.h"
#include "Character/Component/BEPawnPlayableComponent.h"	// for NAME_BindInputsNow
...
void UGameFeatureAction_AddInputConfig::HandlePawnExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
	...
	if (EventName == UGameFrameworkComponentManager::NAME_ExtensionAdded || EventName == UBEPawnPlayableComponent::NAME_BindInputsNow)
	{
