...
UE_DEFINE_GAMEPLAY_TAG(TAG_Flag_IsPlayer				, "Flag.IsPlayer");

UE_DEFINE_GAMEPLAY_TAG(TAG_Flag_UnlimitedHealth			, "Flag.UnlimitedHealth");
UE_DEFINE_GAMEPLAY_TAG(TAG_Flag_UnlimitedCost			, "Flag.UnlimitedCost");

UE_DEFINE_GAMEPLAY_TAG(TAG_Flag_AbilityInputBlocked		, "Flag.AbilityInputBlocked");
UE_DEFINE_GAMEPLAY_TAG(TAG_Flag_SkillActivateBlocked	, "Flag.SkillActivateBlocked");
