...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Input_Ability_Skill_Ultimate);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Input_Ability_Weapon_Attack);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Input_Ability_Weapon_AltAttack);
