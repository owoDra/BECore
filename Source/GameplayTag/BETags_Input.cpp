...
UE_DEFINE_GAMEPLAY_TAG(TAG_Input_Ability_Skill_Main			, "Input.Ability.Skill.Main");
UE_DEFINE_GAMEPLAY_TAG(TAG_Input_Ability_Skill_Sub			, "Input.Ability.Skill.Sub");
UE_DEFINE_GAMEPLAY_TAG(TAG_Input_Ability_Skill_Ultimate		, "Input.Ability.Skill.Ultimate");
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Input_Ability_Weapon_Attack		, "Input.Ability.Weapon.Attack");
UE_DEFINE_GAMEPLAY_TAG(TAG_Input_Ability_Weapon_AltAttack	, "Input.Ability.Weapon.AltAttack");
