#include "BEDeveloperUtilityStatics.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BEDeveloperUtilityStatics)

FString UBEDeveloperUtilityStatics::NameToDisplayString(const FName& Name, const bool bNameIsBool)
{
	return FName::NameToDisplayString(Name.ToString(), bNameIsBool);
}

float UBEDeveloperUtilityStatics::GetAnimationCurveValueFromCharacter(const ACharacter* Character, const FName& CurveName)
{
...
FGameplayTagContainer UBEDeveloperUtilityStatics::GetChildTags(const FGameplayTag& Tag)
{
	return UGameplayTagsManager::Get().RequestGameplayTagChildren(Tag);
}

FName UBEDeveloperUtilityStatics::GetSimpleTagName(const FGameplayTag& Tag)
{
...
float UBEDeveloperUtilityStatics::GetFirstPlayerPingSeconds(const UObject* WorldContext)
{
...
bool UBEDeveloperUtilityStatics::ShouldDisplayDebugForActor(const AActor* Actor, const FName& DisplayName)
{
...
void UBEDeveloperUtilityStatics::DrawHalfCircle(const UObject* WorldContext, const FVector& Location, const FVector& XAxis,
...
void UBEDeveloperUtilityStatics::DrawQuarterCircle(const UObject* WorldContext, const FVector& Location, const FVector& XAxis,
                                    const FVector& YAxis, const float Radius, const FLinearColor& Color,
                                    const float Duration, const float Thickness, const uint8 DepthPriority)
{
#if ENABLE_DRAW_DEBUG
...
void UBEDeveloperUtilityStatics::DrawDebugSphereAlternative(const UObject* WorldContext, const FVector& Location, const FRotator& Rotation,
...
void UBEDeveloperUtilityStatics::DrawDebugLineTraceSingle(const UObject* WorldContext, const FVector& Start, const FVector& End, const bool bHit,
...
void UBEDeveloperUtilityStatics::DrawDebugSweptSphere(const UObject* WorldContext, const FVector& Start, const FVector& End, const float Radius,
...
void UBEDeveloperUtilityStatics::DrawDebugSweepSingleSphere(const UObject* WorldContext, const FVector& Start, const FVector& End,
...
void UBEDeveloperUtilityStatics::DrawDebugSweepSingleCapsule(const UObject* WorldContext, const FVector& Start, const FVector& End,
...
void UBEDeveloperUtilityStatics::DrawDebugSweepSingleCapsuleAlternative(const UObject* WorldContext, const FVector& Start, const FVector& End,
