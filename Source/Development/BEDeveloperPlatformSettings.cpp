...
#include "BEDeveloperPlatformSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BEDeveloperPlatformSettings)


#define LOCTEXT_NAMESPACE "BEPlatform"

UBEDeveloperPlatformSettings::UBEDeveloperPlatformSettings()
{
}

FName UBEDeveloperPlatformSettings::GetCategoryName() const
{
	return FName(FString::Printf(TEXT("%s: Platform"), FApp::GetProjectName()));
}

FName UBEDeveloperPlatformSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UBEDeveloperPlatformSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UBEDeveloperPlatformSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UBEDeveloperPlatformSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UBEDeveloperPlatformSettings::PostInitProperties()
{
...
void UBEDeveloperPlatformSettings::OnPlayInEditorStarted() const
{
...
void UBEDeveloperPlatformSettings::ApplySettings()
{
...
void UBEDeveloperPlatformSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UBEDeveloperPlatformSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UBEDeveloperPlatformSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UBEDeveloperPlatformSettings::PickReasonableBaseDeviceProfile()
{
