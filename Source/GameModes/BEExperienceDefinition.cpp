...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BEExperienceDefinition)

#define LOCTEXT_NAMESPACE "BESystem"


UBEExperienceDefinition::UBEExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UBEExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UBEExperienceDefinition::UpdateAssetBundleData()
{
