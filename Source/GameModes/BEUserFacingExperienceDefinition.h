...
#include "BEUserFacingExperienceDefinition.generated.h"
...
class UBEUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="BEExperienceDefinition"))
