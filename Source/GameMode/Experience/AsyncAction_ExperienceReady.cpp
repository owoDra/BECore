...
void UAsyncAction_ExperienceReady::Step2_ListenToExperienceLoading(AGameStateBase* GameState)
{
	...
	{
		ExperienceComponent->CallOrRegister_OnExperienceLoaded(FOnBEExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::Step3_HandleExperienceLoaded));
	}
}

void UAsyncAction_ExperienceReady::Step3_HandleExperienceLoaded(const UBEExperienceDefinition* CurrentExperience)
{
