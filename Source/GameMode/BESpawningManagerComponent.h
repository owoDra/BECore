...
/**
 * @class UBESpawningManagerComponent
 */
UCLASS()
class BECORE_API UBESpawningManagerComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UBESpawningManagerComponent(const FObjectInitializer& ObjectInitializer);
